...
translations = {
    'hy': {
        ...
        'phage_work_text': 'Ֆագերը կպչում են բակտերիայի մակերեսին, ներարկում իրենց ԴՆԹ-ն։',
        'phage_therapy': 'Ֆագային թերապիա',
        'phage_therapy_text': 'Օգտագործվում է բակտերիալ ինֆեկցիաների բուժման համար։',
    ...
    'ru': {
        ...
        'phage_work_text': 'Фаги прикрепляются к поверхности бактерии, впрыскивают свою ДНК.',
        'phage_therapy': 'Фаговая терапия',
        'phage_therapy_text': 'Используется для лечения бактериальных инфекций.',
    ...
    'en': {
        ...
        'phage_work_text': 'Phages attach to the bacterial surface, inject their DNA.',
        'phage_therapy': 'Phage therapy',
        'phage_therapy_text': 'Used to treat bacterial infections.',
