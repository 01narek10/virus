...
translations = {
    'hy': {
        ...
        'air_purifier_guide_title': '🧼 Օդի մաքրման և ախտահանման սարք. Օգտագործման ուղեցույց',
        'air_purifier_subtitle': 'Ինչպես ճիշտ օգտագործել, անվտանգության կանոններ և սպասարկում',
        'what_is': '🔍 Ի՞նչ է այս սարքը',
        'what_is_text': 'Օդի մաքրման և ախտահանման սարքը նախատեսված է փակ տարածքներում օդից վիրուսները, բակտերիաները, սնկերը, փոշին և ալերգենները հեռացնելու համար: Այն համալրված է HEPA ֆիլտրով, ակտիվացված ածխի ֆիլտրով և ուլտրամանուշակագույն (UV-C) լամպով:',
        'how_to_use_title': '📖 Ինչպես օգտագործել',
        'step1_place': '1. Տեղադրություն',
        'step1_place_text': 'Տեղադրեք սարքը հարթ, կայուն մակերևույթի վրա, պատից առնվազն 30 սմ հեռավորության վրա: Խուսափեք վարագույրների և խոչընդոտների մոտ տեղադրելուց:',
        'step2_power': '2. Միացում',
        'step2_power_text': 'Միացրեք սարքը ցանցին, սեղմեք միացման կոճակը: Առաջին միացման ժամանակ խորհուրդ է տրվում աշխատեցնել առավելագույն արագությամբ 30 րոպե:',
        'step3_speed': '3. Արագության ընտրություն',
        'step3_speed_text': 'Ընտրեք օդափոխիչի արագությունը (1-3 կամ ավտոմատ). 1 – գիշերային, 2 – նորմալ, 3 – ինտենսիվ:',
        'step4_timer': '4. Ժմչփի կարգավորում',
        'step4_timer_text': 'Սարքը ունի ժմչփ (1-8 ժամ), որը թույլ է տալիս այն անջատել նշված ժամանակից հետո:',
        'safety_title': '⚠️ Անվտանգության կանոններ',
        'safety1': '• Մի թողեք սարքը աշխատող վիճակում, եթե տանը փոքր երեխաներ կան առանց հսկողության:',
        'safety2': '• Մի ծածկեք օդի մուտքի/ելքի բացվածքները:',
        'safety3': '• Մի ընկղմեք սարքը ջրի մեջ և մի լվացեք հոսող ջրի տակ:',
        'safety4': '• Անջատեք սարքը ցանցից, նախքան ֆիլտրերը մաքրելը կամ փոխելը:',
        'safety5': '• Մի օգտագործեք սարքը, եթե սնուցման լարը վնասված է:',
        'safety6': '• Պարբերաբար մաքրեք փոշու սենսորը և օդի բացվածքները չոր շորով:',
        'maintenance_title': '🔧 Սպասարկում',
        'maintenance_prefilter': 'Նախնական ֆիլտր. մաքրել փոշեկուլով 2 շաբաթը մեկ:',
        'maintenance_hepa': 'HEPA ֆիլտր. փոխել յուրաքանչյուր 6-12 ամիսը մեկ (կախված օգտագործումից):',
        'maintenance_carbon': 'Ածխային ֆիլտր. փոխել 3-6 ամիսը մեկ:',
        'maintenance_uv': 'UV-C լամպ. փոխել ամեն տարի (եթե մատակարարվում է):',
        'faq_title': '❓ Հաճախ տրվող հարցեր',
        'faq1_q': 'Արդյո՞ք սարքը օզոն է արտադրում:',
        'faq1_a': 'Ոչ, այս մոդելը չի օգտագործում իոնացման տեխնոլոգիա, որը կարող է օզոն արտադրել:',
        'faq2_q': 'Կարո՞ղ է սարքը աշխատել ամբողջ օրը:',
        'faq2_a': 'Այո, նախատեսված է շուրջօրյա աշխատանքի համար:',
        'faq3_q': 'Որքա՞ն է սարքի կողմից արտադրվող աղմուկը:',
        'faq3_a': 'Ամենացածր արագության դեպքում 34 դԲ (համեմատելի է գրադարանի հետ), առավելագույնի դեպքում 55 դԲ:',
        'faq4_q': 'Արդյո՞ք UV-C լամպը վտանգավոր է մարդկանց համար:',
        'faq4_a': 'Ոչ, լամպը փակված է սարքի ներսում և չի ճառագայթում դուրս:',
        'conclusion_title': '📌 Եզրակացություն',
        'conclusion_text': 'Պարբերաբար օգտագործելով սարքը և հետևելով անվտանգության կանոններին, դուք կապահովեք մաքուր և առողջ օդ ձեր տանը կամ գրասենյակում:'
    },
    'ru': {
        'home': '🏠 Главная',
        'map': '🗺️ Карта',
