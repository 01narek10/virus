...
translations = {
    'hy': {
        ...
        'project_model_title': '🧪 Մեր մոդելը. Վիրուս-ախտահանիչ սարք',
        'project_subtitle': 'Նախագիծ. «Վիրուսային հիվանդություններ և դրանց կանխարգելումը»',
        'idea_title': '💡 Գաղափարը',
        'idea_text': 'Սովորական ախտահանիչների փոխարեն մենք ստեղծեցինք վիրուսի տեսք ունեցող սարք, որը կատարում է վիրուսի հակառակ գործառույթը՝ ոչ թե վարակում, այլ մաքրում և ախտահանում է օդը:',
        'appearance_title': '🦠 Արտաքին տեսք',
        'appearance_text': 'Սարքը նման է վիրուսի (գնդաձև, փշերով), սակայն դրա նպատակը օդի մանրէազերծումն է:',
        'how_it_works_title': '⚙️ Ինչպես է աշխատում',
        'how_it_works_text': 'Սարքը բաղկացած է հետևյալ հիմնական մասերից.',
        'component_fan': '💨 12V քուլեր (օդափոխիչ) – ներծծում է կեղտոտ օդը',
        'component_filter': '🔬 Պինդ ֆիլտր – թակարդում է փոշին և խոշոր մասնիկները',
    ...
    'ru': {
        ...
        'project_model_title': '🧪 Наша модель. Вирус-дезинфектор',
        'project_subtitle': 'Проект: «Вирусные заболевания и их профилактика»',
        'idea_title': '💡 Идея',
        'idea_text': 'Вместо обычных дезинфекторов мы создали устройство в форме вируса, которое выполняет обратную функцию: не заражает, а очищает и обеззараживает воздух.',
        'appearance_title': '🦠 Внешний вид',
        'appearance_text': 'Устройство похоже на вирус (шарообразное, с шипами), но его цель — обеззараживание воздуха.',
        'how_it_works_title': '⚙️ Принцип работы',
        'how_it_works_text': 'Устройство состоит из следующих основных частей:',
        'component_fan': '💨 12V кулер (вентилятор) – всасывает грязный воздух',
        'component_filter': '🔬 Твердый фильтр – задерживает пыль и крупные частицы',
    ...
    'en': {
        ...
        'project_model_title': '🧪 Our model: Virus-shaped air sterilizer',
        'project_subtitle': 'Project: "Viral diseases and their prevention"',
        'idea_title': '💡 The idea',
        'idea_text': 'Instead of conventional sterilizers, we built a virus-shaped device that does the opposite: it cleans and sterilizes the air.',
        'appearance_title': '🦠 Appearance',
        'appearance_text': 'The device looks like a virus (spherical, with spikes), but its purpose is air sterilization.',
        'how_it_works_title': '⚙️ How it works',
        'how_it_works_text': 'The device consists of the following main components:',
        'component_fan': '💨 12V fan – draws in dirty air',
        'component_filter': '🔬 Solid filter – traps dust and large particles',
